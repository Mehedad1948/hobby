    ...
    <section className="w-full py-16 md:py-24 bg-black text-white overflow-hidden">
      <div className="max-w-6xl mx-auto px-4 md:px-8 flex flex-col items-center text-center">
        ...
        <div className="w-full mt-16 max-w-md lg:max-w-full mx-auto flex lg:flex-row lg:justify-center flex-col gap-6">
          ...
          <div className="relative p-6 rounded-2xl border-primary-main border bg-primary/10   gap-8  flex  items-center justify-between text-left overflow-hidden h-40">
          ...
          <div className="relative p-6 rounded-2xl border-primary-main border bg-primary/10  flex gap-8  items-center justify-between text-left h-40">
            <div>
          ...
          <div className="relative p-6 rounded-2xl border-primary-main border bg-primary/10  flex items-center justify-between text-left h-40 overflow-hidden">
            <div className="z-10 relative">
